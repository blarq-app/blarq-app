...
- **Ronda 40 bis — Probado en prod + lectura de obra manuscrita (2026-05-31)**:
  ...
  - **Pendiente menor**: sumar el ID de Telegram de JT a `TELEGRAM_ALLOWED_IDS` cuando él pruebe (hoy solo está el de MJ: 5407683316). Probar en vivo el camino manuscrito con una foto real de JT.
