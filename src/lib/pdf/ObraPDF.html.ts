...
const CSS = `
  ...
  * { box-sizing: border-box; }
  ...
  /* La línea que separa el capítulo de sus partidas va en 0.6px y en #625A4F,
     no en tinta plena: sigue leyéndose como corte, pero deja de ser la línea más
     gruesa y más negra de la hoja. El grosor la iguala con los títulos de bloque
     (.blk-title) y la deja por encima del encabezado de columnas (.hd, 0.3px);
     el tono es el mismo del texto de las descripciones. La tinta plena (#36322C)
     queda reservada para el Cuadro Resumen, que NO se toca. */
  .cap { display: flex; justify-content: space-between; align-items: baseline; border-bottom: 0.6px solid #625A4F; padding: 5pt 2pt 3pt; margin-top: 5pt; break-inside: avoid; break-after: avoid; }
