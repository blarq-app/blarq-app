...
- **Fecha**: 2026-06-18
- **Estado**: aceptado
- **Ajustado por**: [2026-09-25](2026-09-25-artefactos-solo-mj-despega-la-linea.md) — hoy una línea se despega solo cuando MJ tipea un precio. Aplicar el precio de la tienda ya no despega (y reconecta), y el precio del catálogo baja solo cuando cambia, no en cada guardado. Los puntos 2 y 3 de abajo describen la regla original.
